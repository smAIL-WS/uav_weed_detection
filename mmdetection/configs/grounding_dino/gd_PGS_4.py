...
optim_wrapper = dict(
    ...
    optimizer=dict(
        lr=4.981943693011744e-05,
        type='AdamW',
        weight_decay=0.0035878886679677406),
    paramwise_cfg=dict(
        custom_keys=dict(
...
resume = False
runner = dict(max_epochs=29, type='EpochBasedRunner')
...
train_cfg = dict(max_epochs=29, type='EpochBasedTrainLoop', val_interval=1)
